= ocp4-workload-days-ops-track - OpenShift Days Ops Track Workshop Setup

== Role overview

* This role sets up the OpenShift Days Ops Track workshop environment. It consists of the following tasks files:
...
ansible-playbook -i ${TARGET_HOST}, ./configs/ocp-workloads/ocp-workload.yml \
    ...
    -e"ocp_workload=ocp4-workload-days-ops-track" \
    -e"silent=False" \
